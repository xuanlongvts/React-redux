...
var _cartsReducers = __webpack_require__(26);

exports.default = (0, _redux.combineReducers)({
    books: _booksReducers.booksReducers,
    carts: _cartsReducers.cartsReducers
});
...
function booksReducers() {
    ...
    switch (action.type) {
        ...
        case 'DELETE_BOOK':
            var currentBookToDelete = state.books;
        ...
        case 'UPDATE_BOOK':
            ...
            var currentBookToUpdate = state.books;
...
exports.cartsReducers = cartsReducers;

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

function cartsReducers() {
